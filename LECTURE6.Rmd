...
Cuando es que $k$ es la edad máxima.
...
**Q:** Implement this equation in Excel. Is this an exponentially growing population?
  ...
  Fill in the blanks:  Usa las formulas aprendida para calcular llenar los blancos
...
```
  ...
  Cual son las definiciones matemática y ecológica de cada una de las variables en la tabla.
