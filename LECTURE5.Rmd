...
`r colorize("To do this, define your *Births per Capita* using the following syntax:.", "blue")`
...
`r colorize("Similarly, define your *Deaths per capita* using the following syntax:.", "blue")`
...
`r colorize("5. If we are running out of time in class (which we probably will be!), load the model (and clone it!) using [this link](https://insightmaker.com/insight/71147/Allee-Effect-1#)!.", "blue")`   
...
**Q:**  Haz una pequeña busqueda de literatura para averiguar cual otra especie pudiese tener un efecto ALLEE y describe un 3-4 lineas de lo que se conoce de esta especies y el efecto Allee.  
