...
El modelo básico asume que cuando individuos se añaden a la población, el efecto sobre la razón de crecimiento es imediato.  Pero en muchas especies el efecto se puede ser postergado a un momento en el futuro.  

Ejemplos:
 - Plantas anuales no tienen time lag (asumiendo que no hay banco de semillas)
 - Los elefantes comienzan a reproducirse solamente despues de 14-15 años
 - Los coquis se pueden reproducir a la edad de ± 8 meses
 - El árbol de "Brazil Nuts", *Bertholletia excelsa* necesita más de 120 años antes de producir flores.
 - La Caoba, *Swietenia mahogani* tienen que tener 50 años antes de comenzar a reproducrise
 ...
 $$\frac{dN}{dt}=rN_{i}(1-\frac{N_{i-t}}{K})$$ por consecuencia el efecto sobre el crecimiento esta atrasado por el tiempo $t$, donde la $i$ representa el tiempo.  El comportamiento de los que es una **ecuación differencial de retardo** depende de 2 factores.
  ...
  1) el tiempo del tiempo de retardo,  $\tau$ (se dice *tau*), 
...
```
 ...
 See this website for visualizing change in time of a simple logistic model
