...
En general lo que uno es separar la matriz de transciones de la matriz de fecundidad.  Eso es para tener claro los procesos que ocurren en la población.   Sumando ambas matriz tenemos la matriz para evaluar la dinamica poblacional de esa población.  
...
```{r}
matA1 <- matrix(c(
  0.2500000, 0.6250000, 0.2000000, 0.3333333,
  0.7500000, 0.1250000, 0.4000000, 0.0000000,
  0.0000000, 0.100000, 0.2000000, 0.3333333,
  0.0000000, 0.2500000, 0.2000000, 0.3333333), byrow = 4, ncol = 4)



matA1

colnames(matA1) <- c("plantulas", "juveniles", "adulto no reproductivos", "adultos reproductivos")
rownames(matA1) <- colnames(matA1)

stages_orchid1 <- c("1-2", "3-4", "5", "6")

plot_life_cycle(matA1, stages = stages_orchid1) 
