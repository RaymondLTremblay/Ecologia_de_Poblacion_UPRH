...
*Lepanthes* is one of the largest of orchids with >1200 species, found only in the Neotropics
...
A population of *Lepanthes rupestris*, those of Lepanthes rubripetala growth in the smae way (on rocks or trees)
...
[Tremblay, Raventos Ackerman](PDF/When stable-stage equilibrium is unlikely- integrating transient population dynsmics.pdf)
...
structure, the asymptotic growth rate will be the same) and 

 - **irreducibility**
(the condition that the transitions from all stages to all other
stages are possible), 

both of which may severely impact matrix structure
