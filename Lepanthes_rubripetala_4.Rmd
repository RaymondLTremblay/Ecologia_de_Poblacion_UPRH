...
Sin embargo, los datos de la siguiente matriz son limitados porque la colonización de semillas por los no se puede detectar en el campo con facilidad, porque las semillas son demasiado pequeñas y no existe una técnica rápida en el campo para detectar los hongos simbióticos.

Esta matriz se basa en el tamaño, con una fecundidad media.
