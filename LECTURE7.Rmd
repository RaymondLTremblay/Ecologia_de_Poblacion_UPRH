...
$\mathbf{A} $ es una **matriz ** (la matriz de transición)
...
¡Todo lo que necesita hacer es obtener el  _eigenvectoc derecho de $\mathbf{A}$_! Este vector representa las abundancias relativas en cada clase de edad en la distribución de edad estable.
...
Echemos un vistazo a una población básica estructurada por edad, específicamente el ejemplo en clase de la última conferencia. ([this one](https://insightmaker.com/insight/70809/Age-structured-population).). 
Echemos un vistazo a una población básica estructurada por edad, específicamente el ejemplo en clase de la última conferencia.
...
"La producción per cápita de _(nombre de la fila)_ por _(nombre de la columna)_ es _(valor del elemento)_"
...
_Todo lo que pueda hacer con un modelo de población matricial, también puede hacerlo en InsightMaker (o R, o cualquier otra plataforma de programación)_ (¡pero puede que no sea tan 'bonito' o elegante como un modelo de población matricial!)
...
Para obtener más información sobre los modelos matriciales de población, la Biblia de este tema es [this book by Hal Caswell](https://www.amazon.com/gp/huc/view.html?ie=UTF8&newItems=C1DH1414B1C6AK%2C1).
Y finalmente, mira esto: esta es una base de datos de miles de matrices de etapas para plantas y animales en todo el mundo:
